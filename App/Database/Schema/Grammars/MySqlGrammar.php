...
class MySqlGrammar extends Grammar
{
     ...
     *
     * @param  \App\Database\Schema\Blueprint $blueprint
     * @param  \App\Support\Fluent $command
    ...
    protected function compileCreateEncoding($sql, Blueprint $blueprint)
    {
        ...
        } elseif (!is_null($charset = $this->getConfig('charset'))) {
        ...
        } elseif (!is_null($collation = $this->getConfig('collation'))) {
    ...
    protected function compileCreateEngine($sql,  Blueprint $blueprint)
    {
        ...
        } elseif (!is_null($engine = $this->getConfig('engine'))) {
     ...
     *
     * @param  \App\Support\Fluent $column
     * @return string
     */
