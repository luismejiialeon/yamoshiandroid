...
*}
<div class="panel"><h3><i class="icon-list-ul"></i> {l s='Slides list' d='Modules.AndroidSlide.Admin'}
	<span class="panel-heading-action">
		<a id="desc-product-new" class="list-toolbar-btn" href="{$controllerSelft->getAddLink()}">
						...
						<div class="col-md-8">
								...
								{if $slide.is_shared}
									<div>
										<span class="label color_field pull-left" style="background-color:#108510;color:white;margin-top:5px;">
											{l s='Shared slide' d='Modules.AndroidSlide.Admin'}
										</span>
									</div>
								{/if}
							</h4>
							<div class="btn-group-action pull-right">
								...
								<a class="btn btn-default"
									href="{$controllerSelft->getEditLink([
								...
								<a class="btn btn-default"
								   href="{$controllerSelft->getControllerLink('deleteSlider',[
								   "id_slide"=>{$slide.id_slide}
								   ])}">
